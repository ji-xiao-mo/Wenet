...
class POGO(torch.optim.Optimizer):
    ...
    def __init__(
        ...
        # Handle PyTorch 2.10+ where Adam doesn't have get_defaults()
        try:
            base_defaults = base_optimizer.get_defaults()
        except (AttributeError, TypeError):
            # Fallback for PyTorch 2.10+ or custom optimizers
            base_defaults = {'betas': (0.9, 0.999), 'eps': 1e-8, 'foreach': None}
